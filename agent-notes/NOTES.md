...
- For mounted sandbox run logs, avoid direct append (`>>`) to mounted paths; append to local `/tmp/.sandbox-logs/log.ndjson` and mirror with full-file copy/overwrite.
